...
/**
 * Classe Attaquer de notre interface Strategie qui implémente Strategie
 * 
...
public class Attaquer implements Strategie {
	...
	/**
	 * méthode attaquer qui réalise l'action offensive comme décrite dans la cahier des charges.
	 */
	...
	/**
	 * méthode nomStrat qui renvoie "attaquer"
	 * @return String "attaquer"
	 */
