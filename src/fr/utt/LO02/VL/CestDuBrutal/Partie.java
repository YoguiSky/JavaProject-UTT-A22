...
public final class Partie {
	...
	public static void main(String[] args) {
		...
		partie.Zones.put(2,
				new Zone("Le Bureau Des Etudiants", joueur1.getFactionJoueur(), joueur2.getFactionJoueur()));
		partie.Zones.put(3,
				new Zone("Le Quartier Administratif", joueur1.getFactionJoueur(), joueur2.getFactionJoueur()));
		partie.Zones.put(4,
				new Zone("Les Halles industrielles", joueur1.getFactionJoueur(), joueur2.getFactionJoueur()));
